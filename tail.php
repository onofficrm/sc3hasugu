...
$g5_footer_tel_display = function_exists('g5site_cfg') ? g5site_cfg('phone', '') : '';
$g5_footer_tel_link    = function_exists('g5site_tel_link') ? g5site_tel_link($g5_footer_tel_display) : '#';
$g5_footer_kakao_url   = '';
$g5_footer_company     = function_exists('g5site_cfg') ? g5site_cfg('company_name', '원진하수구') : '원진하수구';
$g5_footer_ceo         = function_exists('g5site_cfg') ? g5site_cfg('ceo_name', '') : '';
$g5_footer_intro       = function_exists('g5site_cfg') ? g5site_cfg('footer_desc', '구리시 하수구청소 전화상담') : '구리시 하수구청소 전화상담';
$g5_footer_biz_no      = function_exists('g5site_cfg') ? g5site_cfg('business_no', '') : '';
$g5_footer_sales_no    = function_exists('g5site_cfg') ? g5site_cfg('sales_no', '') : '';
$g5_footer_privacy     = function_exists('g5site_cfg') ? g5site_cfg('privacy_manager', '') : '';
$g5_footer_email       = function_exists('g5site_cfg') ? g5site_cfg('email', '') : '';
$g5_footer_address     = function_exists('g5site_cfg') ? g5site_cfg('address', '') : '';
$g5_footer_fax         = function_exists('g5site_cfg') ? g5site_cfg('fax', '') : '';
