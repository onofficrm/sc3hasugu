...
<article class="board-wrap board-wrap--cases-gallery board-view board-view--gallery" id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section class="board-view__body board-view__body--gallery" id="bo_v_atc">
        ...
        <?php include_once(G5_PATH.'/skin/board/_inc/g5b-gallery-view.php'); ?>
