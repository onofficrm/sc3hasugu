...
<section class="board-wrap board-wrap--cases-gallery board-write board-write--cases-gallery" id="bo_w" style="width:<?php echo $width; ?>">
    <h2 class="sound_only"><?php echo $g5['title'] ?></h2>

    <div class="board-write__intro">
        <h3><?php echo ($w === 'u') ? '시공사례 수정' : '시공사례 등록'; ?></h3>
    ...
    <div class="btn_confirm write_div board-write-form__submit">
        ...
        <button type="submit" id="btn_submit" accesskey="s" class="btn_submit btn board-actions__write"><?php echo ($w === 'u') ? '수정완료' : '등록완료'; ?></button>
    </div>
    </form>
